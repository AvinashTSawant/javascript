...
console.log(`    Average salary of the employee for all the department is: ${averageSalary}`);
...
// console.log(`    IT departments eployees total salary is: ${arrayOfAverageSalaryOfIt}`);
