...
console.log( `--------------------------------------------------------------------`,)
console.log(`4.Log the employee details `)
...
console.log( `--------------------------------------------------------------------`,)
console.log(`5.deep copy using JSON.stringify() `)
...
console.log(`5.c Original object salary ; ${employee_info.salary.july_month} `);

console.log(`5.c cloned  object salary :- ${deepClonedemployee_info.salary.july_month}`);


console.log(`----- up date country= 'United Kingdom' in original object-----`);


console.log(`5.c Original object country ; ${employee_info.address.country} `);

console.log(`5.c cloned  object country :- ${deepClonedemployee_info.address.country}`);
